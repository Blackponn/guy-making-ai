...
import {Bodytypes} from '../components/bodytype';
...
export default function Home() {
  return (
    <>
      ...
      <h1 className="text-center text-[32px] font-bold text-[#000000] pt-[72px]">{"Body Type"}</h1>
      <h2 className="text-center text-[16px] font-regular text-[#636363]">{"7/8"}</h2>
